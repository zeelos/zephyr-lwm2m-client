...
This example is based on the `LWM2M sample <https://github.com/zephyrproject-rtos/zephyr/tree/master/samples/net/lwm2m_client>`_ that comes with the Zephyr distribution, modified to include a `random temperature generation <https://github.com/zeelos/zephyr-lwm2m-client/blob/master/src/lwm2m-client.c#L238-L263>`_ for testing purposes. Further, it's mainly tested on a `BLE Nano 2 Kit <https://redbear.cc/product/ble-nano-kit-2.html>`_ together with DTLS and IPv6 using the included `'overlay-dtls.conf' <https://github.com/zeelos/zephyr-lwm2m-client/blob/master/overlay-dtls.conf>`_ and `'overlay-bt.conf' <https://github.com/zeelos/zephyr-lwm2m-client/blob/master/overlay-bt.conf>`_ configuration files. For more information (including setup), please visit the official `LWM2M documentation page <https://docs.zephyrproject.org/latest/samples/net/lwm2m_client/README.html>`_ on the `Zephyr project. <https://www.zephyrproject.org>`_
